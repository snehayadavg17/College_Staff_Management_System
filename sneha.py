...
connectiondb = mysql.connector.connect(host="localhost",user="root",passwd="root",database="staff_management_system1")
...
def login_verification():
    ...
    sql = "select * from alogin where email = %s and password = %s"
